...
namespace DataJuggler.Net7
{
	...
	{  
        ...
        private const string DelegatesReference = "DataJuggler.Net7.Delegates";
        private const string EnumerationsReference = "DataJuggler.Net7.Enumerations";
        #endregion
		...
		#region Methods
            ...
            #region CloneField(DataJuggler.Net7.DataField field,string newObjectName)
            public string CloneField(DataJuggler.Net7.DataField field,string newObjectName)
			{
                // local
			...
			#region CreateForEach(DataJuggler.Net7.DataTable table)
			/// <summary>
			/// This method creates a foreach for each field in the table
			/// </summary>
			/// <param name="table"></param>
			/// <returns></returns>
			public string CreateForEach(DataJuggler.Net7.DataTable table)
			{
            ...
            #region GetCompareLine(DataJuggler.Net7.DataTable table, string primaryKeyName)
            /// <summary>
            ...
            /// <returns></returns>
            public string GetCompareLine(DataJuggler.Net7.DataTable table, string primaryKeyName)
			{
			...
			public void InitializeStrings(List<DataField> fields)
			{
				...
				foreach(DataJuggler.Net7.DataField field in fields)
				{
			...
			#region LoadField(DataJuggler.Net7.DataField field)
			public string LoadField(DataJuggler.Net7.DataField Field)
			{
				// String Builder  
				StringBuilder sb = new StringBuilder("this.");
			...
			#region NullField(DataJuggler.Net7.DataField field)
			public string NullField(DataJuggler.Net7.DataField Field)
			{
				// Create StringBuilder
            ...
            #region ParseFieldValue(DataJuggler.Net7.DataField field)
            /// <summary>
            /// Parse the field value
            /// </summary>
            /// <param name="field"></param>
            /// <returns></returns>
            public string ParseFieldValue(DataJuggler.Net7.DataField field)
			{
				// Create StringBuilder Object
				StringBuilder sb = new StringBuilder();
			...
			#region SaveObject(DataJuggler.Net7.DataTable table)
			/// <summary>
			...
			/// <param name="table"></param>
			/// <returns></returns>
			public string SaveObject(DataJuggler.Net7.DataTable table)
			{
				// Create New Object Name
			...
			#region UpdateLine(DataJuggler.Net7.DataField field)
			public string UpdateLine(DataJuggler.Net7.DataField Field)
			{
			...
			private void WriteAddMethod(DataJuggler.Net7.DataTable table)
			{
			...
			{	
				// Write Each Class
				foreach(DataJuggler.Net7.DataTable table in tables)
				{
			...
			private void WriteConstructor(DataJuggler.Net7.DataTable table)
			{
			...
			#region WriteCreateTableMethod(DataJuggler.Net7.DataTable table)
			private void WriteCreateTableMethod(DataJuggler.Net7.DataTable table)
			{
				...
				// Write BeginRegion "CreateTable(DataJuggler.Net7.DataTable table)";
				line = "CreateTable(DataJuggler.Net7.DataTable table)";
				BeginRegion(line);

				// Write Method Name
				line = "private void CreateTable(DataJuggler.Net7.DataTable table)";
				WriteLine(line);
				...
				// Instanciate table
				line = "this.table = new DataJuggler.Net7.DataTable();";
				WriteLine(line);

				// Create field For Adding To Fields Collection
				line = "DataJuggler.Net7.DataField field = new DataJuggler.Net7.DataField();";
				WriteLine(line);
				...
				foreach(DataJuggler.Net7.DataField Field in table.ActiveFields)
				{
					// Write Blank Line
					WriteLine();
					...
					line = "field = new DataJuggler.Net7.DataField();";
					WriteLine(line);
			...
			#region WriteDataClassVariables(DataJuggler.Net7.DataTable table)
			private void WriteDataClassVariables(DataJuggler.Net7.DataTable table)
			{
				// local StringBuilder
				StringBuilder sb = new StringBuilder();
			...
			#region WriteDeleteChanges(DataJuggler.Net7.DataTable table)
			private void WriteDeleteChanges(DataJuggler.Net7.DataTable table)
			{
			...
			private void WriteExportToDataRowMethod(DataJuggler.Net7.DataTable dataTable)
			{
				...
				// Create row
				DataJuggler.Net7.DataRow dataRow = new DataRow(dataTable);
			...
			#region WriteGetIndex(DataJuggler.Net7.DataTable table)
			private void WriteGetIndex(DataJuggler.Net7.DataTable table)
			{
			...
			#region WriteInitialChanges(DataJuggler.Net7.DataTable table)
			private void WriteInitialChanges(DataJuggler.Net7.DataTable table)
			{
			...
			#region WriteLoadMethodFromDataRow(DataJuggler.Net7.DataTable table)
			private void WriteLoadMethodFromDataRow(DataJuggler.Net7.DataTable table)
			{
				// Local Variable
				string line = "";
			...
			#region WriteLoadMethods(DataJuggler.Net7.DataTable table)
			private void WriteLoadMethods(DataJuggler.Net7.DataTable table)
			{	
			...
			#region WriteMethods()
			private void WriteMethods(DataJuggler.Net7.DataTable table)
			{
				// Begin Region Constructor
				BeginRegion("Methods");
			...
			#region WriteProperties(DataJuggler.Net7.DataTable table) void
			private void WriteProperties(DataJuggler.Net7.DataTable table)
			{
			...
			public void WriteReferences(ReferencesSet references, bool requireDelegatesReference = false)
			{
                ...
                try
                {
                    ...
                    {  
                        ...
                        // if this reference name equals DataJuggler.Net7.Delegates
                        ...
                        // if this reference name equals DataJuggler.Net7.Enumerations
                    ...
                    if ((requireDelegatesReference) && (!hasDelegateReference))
                    {
                        ...
                        // write out the reference for DataJuggler.Net7.Delegates
                    ...
                    if ((requireDelegatesReference) && (!hasEnumerationsReference))
                    {
                        ...
                        // write out the reference for DataJuggler.Net7.Enumerations
                        WriteReference(referenceObject);
                    }
