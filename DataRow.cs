...
namespace DataJuggler.Net7
{
	...
	public class DataRow
	{
		...
		private int index;
		private DataJuggler.Net7.DataTable parentTable;
		private string tag;
		#endregion
		...
		#region Constructor
			...
			#region DataRow(DataJuggler.Net7.DataTable ParentDataTable)
			public DataRow(DataJuggler.Net7.DataTable ParentDataTable)
			{
				// Set Parent table
		...
		#region Methods
			...
			#region PrimaryKey()
			public DataJuggler.Net7.DataField PrimaryKey()
			{
				// Create DataField 
				DataJuggler.Net7.DataField NoField = new DataField();
				NoField.FieldName = "void";

				// Search For PrimaryKey
				foreach(DataJuggler.Net7.DataField Field in this.Fields)
				{
		...
		#region Properties
			...
			#region ParentTable
			public DataJuggler.Net7.DataTable ParentTable
			{
				get
				{
					return parentTable;
