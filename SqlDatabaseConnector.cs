...
namespace DataJuggler.Net7
{
    ...
    public class SQLDatabaseConnector
	{
		...
		#region Methods
			...
			#region BuildTableSQL(DataJuggler.Net7.DataTable dataTable)
			public string BuildTableSQL(DataJuggler.Net7.DataTable dataTable)
			{
                ...
                try
                {
                    ...
                    if (NullHelper.Exists(table))
                    {
                        ...
                        foreach (System.Data.DataRow databaseField in schemaTable.Rows)
                        {
                            ...
                            DataJuggler.Net7.DataField field = new DataField();
			...
			#region IsPrimaryKeyUpdateable(DataJuggler.Net7.DataTable table)
			/// <summary>
			...
			public bool IsPrimaryKeyUpdateable(DataJuggler.Net7.DataTable table)
			{
			...
			#region LoadDataRows() +1 overrides
				...
				#region LoadDataRows(DataJuggler.Net7.DataTable table)
				/// <summary>
				/// Loads All Rows For This table
				/// </summary>
				/// <param name="table"></param>
				/// <returns></returns>
				public List<DataRow> LoadDataRows(DataJuggler.Net7.DataTable dataTable)
				{
				...
				#region LoadDataRows(DataJuggler.Net7.DataTable table, string sql)
				/// <summary>
				...
				/// <param name="sql"></param>
				/// <returns></returns>
				public List<DataRow> LoadDataRows(DataJuggler.Net7.DataTable dataTable, string sql)
				{	
            ...
            public List<DataTable> LoadDataTablesSchema(Database parentDatabase)
			{
				...
				{				
					...
					{	
						// Create A New table
						DataJuggler.Net7.DataTable dataTable = new DataJuggler.Net7.DataTable();
            ...
            public DataJuggler.Net7.DataTable LoadDataTableSchema(Database parentDatabase, string tableName)
            {
                // initial value
                ...
                try
                {
                    ...
                    {
                        // Create A New table
                        DataJuggler.Net7.DataTable dt = new DataJuggler.Net7.DataTable();
			...
			public List<StoredProcedure> LoadStoredProcedures(List<DataTable> tables)
			{
				...
				try
				{
					...
					foreach(System.Data.DataRow dr in ds.Tables["Procedures"].Rows)
					{
						...
						DataJuggler.Net7.StoredProcedure sp = new StoredProcedure();
