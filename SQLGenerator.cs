...
namespace DataJuggler.Net7
{
	...
	public class SQLGenerator
	{
		...
		#region Methods
			...
			#region BuildFieldClause(DataJuggler.Net7.DataField field)
			public string BuildFieldClause(DataJuggler.Net7.DataRow FieldRow, DataJuggler.Net7.DataField Field, int FieldCount)
			{
				// if FieldCount > 0
			...
			#region BuildWhereClause(DataJuggler.Net7.DataRow row)
			public string BuildWhereClause(DataJuggler.Net7.DataRow Row)
			{
				...
				foreach(DataJuggler.Net7.DataField Field in Row.Fields)
				{
			...
			#region CreateDeleteSQL(DataJuggler.Net7.DataRow row)
			public string CreateDeleteSQL(DataJuggler.Net7.DataRow Row)
			{
			...
			#region CreateInsertSQL(DataJuggler.Net7.DataRow row) +1 override
			
				#region CreateInsertSQL(DataJuggler.Net7.DataRow row)
				public string CreateInsertSQL(DataJuggler.Net7.DataRow Row)
				{
				...
				#region CreateInsertSQL(DataJuggler.Net7.DataRow row, bool WithOrWithoutChanges)
				public string CreateInsertSQL(DataJuggler.Net7.DataRow Row, bool WithOrWithoutChanges)
				{
			...
			#region CreateSelectAllSQL(DataJuggler.Net7.DataTable table) 
			/// <summary>
			...
			public string CreateSelectAllSQL(DataJuggler.Net7.DataTable dataTable)
			{		
			...
			#region CreateSelectSQL(DataJuggler.Net7.DataTable table, int primaryKeyValue) +3 overrides
			
				#region CreateSelectSQL(DataJuggler.Net7.DataTable table, int primaryKeyValue) 
				/// <summary>
				...
				/// </summary>
				/// <param name="table">DataJuggler.Net7.DataTable</param>
				...
				public string CreateSelectSQL(DataJuggler.Net7.DataTable table, int primaryKeyValue)
				{
				...
				#region CreateSelectSQL(DataJuggler.Net7.DataTable table, double primaryKeyValue) 
				/// <summary>
				/// Returns a valid sql statement to load an object from a table based upon the primary key.
				/// This is for a single field primary key.
				/// </summary>
				...
				/// <returns>A valid sql statement if the table has a primary key</returns>
				public string CreateSelectSQL(DataJuggler.Net7.DataTable table, double primaryKeyValue)
				{
					// Verify table Has A Primary Key
					if(table.PrimaryKey != null)
					{
				...
				#region CreateSelectSQL(DataJuggler.Net7.DataTable table, string primaryKeyValue) 
				/// <summary>
				/// Returns a valid sql statement to load an object from a table based upon the primary key.
				/// This is for a single field primary key.
				/// </summary>
				...
				/// <returns>A valid sql statement if the table has a primary key</returns>
				public string CreateSelectSQL(DataJuggler.Net7.DataTable table, string primaryKeyValue)
				{
					// Verify table Has A Primary Key
					if(table.PrimaryKey != null)
					{
				...
				#region CreateSelectSQL(DataJuggler.Net7.DataTable table, string fieldName, string fieldValue) 
				/// <summary>
				...
				public string CreateSelectSQL(DataJuggler.Net7.DataTable table, string fieldName, string fieldValue)
				{
					// bool UseQuotes
			...
			#region CreateUpdateSQL(DataJuggler.Net7.DataRow row)
			public string CreateUpdateSQL(DataJuggler.Net7.DataRow Row)
			{
				// Boolean For Is This The First field
				bool FirstField = true;
			...
			public bool IsString(DataJuggler.Net7.DataTable table, string fieldName)
			{
                // initial value
                bool isString = false;
                
				// Create Generic row
				DataJuggler.Net7.DataRow row = new DataRow();
			...
			#region IsUpdateable(DataJuggler.Net7.DataRow row)
			public bool IsUpdateable(DataJuggler.Net7.DataRow Row)
			{
                // Initial Value
                bool updateable = false;

				// Check If There Is A PrimaryKey
				DataJuggler.Net7.DataField PrimaryKey = Row.PrimaryKey();
